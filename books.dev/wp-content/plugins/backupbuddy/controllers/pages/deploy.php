...
if ( ! defined( 'BACKUPBUDDY_API_AUTH' ) || ( 'CHANGEME' == BACKUPBUDDY_API_AUTH ) || ( strlen( BACKUPBUDDY_API_AUTH ) < 5 ) ) {
	pb_backupbuddy::alert( "Make sure the following is in your wp-config.php file on this server:<br><textarea style='width: 100%;' disabled='disabled'>define( 'BACKUPBUDDY_API_AUTH', 'CHANGEME' ); // !!! IMPORTANT !!! Change CHANGEME to the left to a unique password/phrase for generating API keys. 5+ characters.</textarea>" );
	return false;
}
