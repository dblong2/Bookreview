...
if ( ( '' != pb_backupbuddy::_POST( 'backupbuddy_api_key' ) ) && ( pb_backupbuddy::$options['api_key'] == pb_backupbuddy::_POST( 'backupbuddy_api_key' ) ) ) { // Provided API key matches.
	if ( ( '' != pb_backupbuddy::$options['api_key'] ) && defined( 'BACKUPBUDDY_API_ENABLE' ) && ( TRUE == BACKUPBUDDY_API_ENABLE ) && defined( 'BACKUPBUDDY_API_AUTH' ) && ( 'CHANGEME' != BACKUPBUDDY_API_AUTH ) && ( strlen( BACKUPBUDDY_API_AUTH ) >= 5 ) ) { // Verify API is enabled.
		$api_authed = true;
